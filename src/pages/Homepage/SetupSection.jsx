...
const SetupSection = () => {
  ...
  return (
    <div className="container">
      <div className="setup-section-wrapper">
        <div className="header">
          <button className="product-solution">Products & Solutions</button>
          <h2 className="description">
            Through our products and solutions, we empower engineering colleges,
            polytechnic institutes, and industrial training centers to bridge
